...
class StatProcessor {
  ...
  static void processForNumStat(FuncInfo fi, ForNumStat node) {
    ...
    LocalVarDeclStat lvdStat =
        LocalVarDeclStat(0, [forIndexVar, forLimitVar, forStepVar], [node.initExp, node.limitExp, node.stepExp]);
  ...
  static void processForInStat(FuncInfo fi, ForInStat node) {
    ...
    LocalVarDeclStat lvdStat = LocalVarDeclStat(0, [forGeneratorVar, forStateVar, forControlVar], node.expList);
    processLocalVarDeclStat(fi, lvdStat);
